...
Question 3:
-----------
After fitting a model to data, what checks would you perform to confirm that
this has been done correctly?

Question 4:
-----------
Find using the sum of the solutions, x0 + x1 + x2, of the following set of equations...

    [[9.88147746930662   9.446294330943026  6.867343600899789 ]       [x0]       [1.7147395700538763]
     [3.3013023006376    8.866849207559063  2.5855821434029   ]   *   [x1]   =   [3.82744793002092  ]
     [7.897613140999123  2.5810421630855136 9.843121360475344 ]]      [x2]       [8.883242030765913 ]
...
Question 6:
-----------
Solve the following differential equation using finite differences and solving
...
Plot the function H(g) in the interval [0,5] using 10, 50, 100, 200 points
when discretizing the independent variable.
If k = 5.538013, how would you tackle the problem and how would the solution change?

Question 7:
-----------
The cosine coefficients in a Fourier series expansion of a periodic function
on the interval [-l, l) can be defined as...

    a_m = \frac{1}{l} \int_{-l}^{l} \phi_m(x) f(x) \, dx,
    \text{where } \phi_m(x) = \cos\left(\frac{m \pi x}{l}\right)
...
Calculate numerically a_1 (the coefficient of cos(2πx)) in the Fourier series
expansion of f(x) = 4(x - 1/2)^2 defined on [0, 1).
